...
ORCHESTRATOR_APPEND = (
    ...
    "boss. Do not poll; do not micro-manage a working worker. If a worker's "
    "checkpoint needs nothing from the boss, reply with exactly the single word "
    "NOTHING — no message is posted (this is the quiet, healthy default; don't "
    "narrate 'noted' or 'all good', which WOULD post).\n"
